...
class SbomReportExecutionStatusResultSchema(Schema):
    class Meta:
        unknown = EXCLUDE
    ...
    @post_load
    def build_dto(self, data: Dict[str, Any], **_) -> 'SbomReportStatus':
        return SbomReportStatus(**data)
