...
def _get_relevant_files(progress_bar: 'BaseProgressBar', scan_type: str, path: str) -> List[str]:
    ...
    relevant_files_to_scan = exclude_irrelevant_files(progress_bar, scan_type, all_files_to_scan)
...
def get_relevant_document(
    progress_bar: 'BaseProgressBar', scan_type: str, path: str, *, is_git_diff: bool = False
) -> List[Document]:
    relevant_files = _get_relevant_files(progress_bar, scan_type, path)
