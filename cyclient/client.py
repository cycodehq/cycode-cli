...
class CycodeClient:
    ...
    def __init__(self, client_id: str, client_secret: str):
        ...
        self.base_url = 'http://localhost:5025'  # config.base_url
        ...
        self.session.headers.update(
            {
                ...
                # 'x-metadata-runner': '1', # installation id
                # # TODO: delete, dummy tenant for local debugging
                "x-tenant-id": "1a15609e-b2c2-4a90-a658-79518f72a956"
            }
        )
